<?php
	...
	*/
	...
	//will delete the booking from the BOOKING tble where the request_id = the passed request_id
	//as the request_id in the BOOKING table are distinct, this will not be a problem
	$sql = "DELETE FROM BOOKING WHERE request_id = $request_id";
	...
	//updating the request with teh correct information that has eben inputted via the dialogue
